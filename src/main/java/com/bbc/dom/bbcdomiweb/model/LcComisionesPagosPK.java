 ...
 */
@Embeddable
public class LcComisionesPagosPK implements Serializable {
    ...
    @Basic(optional = false)
    @NotNull
    @Column(name = "SECUENCIA_PAGO")
    private long secuenciaPago;

    public LcComisionesPagosPK() {
    }

    public LcComisionesPagosPK(short codigoEmpresa, short codigoAgencia, short codigoSubAplicacion, int numeroLineaCredito, short codigoTasa, short numeroCuota, long secuenciaPago) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LcComisionesPagosPK)) {
            return false;
        }
        LcComisionesPagosPK other = (LcComisionesPagosPK) object;
        ...
        if (this.secuenciaPago != other.secuenciaPago) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.bbc.dom.bbcdomiweb.model.LcComisionesPagosPK[ codigoEmpresa=" + codigoEmpresa + ", codigoAgencia=" + codigoAgencia + ", codigoSubAplicacion=" + codigoSubAplicacion + ", numeroLineaCredito=" + numeroLineaCredito + ", codigoTasa=" + codigoTasa + ", numeroCuota=" + numeroCuota + ", secuenciaPago=" + secuenciaPago + " ]";
    }
