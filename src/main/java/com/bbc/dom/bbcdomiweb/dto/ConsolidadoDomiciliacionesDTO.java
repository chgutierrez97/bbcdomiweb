 ...
 */
public class ConsolidadoDomiciliacionesDTO {
    private Long id;
    ...
    public ConsolidadoDomiciliacionesDTO() {
    }

    public ConsolidadoDomiciliacionesDTO(Long id, Date fechaHoraCarga, String nombreArchivo, BigInteger nroRegistrosProcesar, BigInteger nroRegistrosRechazados, BigInteger nroRegistrosValidados, BigInteger nroRegistrosPendientes) {
        super();
        this.id = id;
